  ...
  const renderCustomizationGrid = (
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      {items.map((item) => (
        ...
        >
          <CardContent
            className={`p-4 text-center ${getRarityBg(item.rarity)}`}
          >
            ...
            {selectedItems[category as keyof typeof selectedItems] ===
              item.id && (
              <div className="mt-2">
            ...
            <Card className="sticky top-8">
              ...
              <CardContent className="text-center">
                <Character3DPreview
                  customization={{
                    hair:
                      hairStyles.find((h) => h.id === selectedItems.hair)
                        ?.name || "Classic",
                    face:
                      faces.find((f) => f.id === selectedItems.face)?.name ||
                      "Friendly",
                    jersey:
                      jerseys.find((j) => j.id === selectedItems.jersey)
                        ?.name || "Home Kit",
                    shorts: "Standard",
                    boots:
              ...
              <TabsContent value="appearance" className="space-y-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Select your character's personality
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="equipment" className="space-y-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Choose your team colors and style
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Select boots that match your play style
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="celebrations" className="space-y-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Show off your style when you score
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="text-center py-8">
                    ...
                    <div className="text-muted-foreground">
                      More celebrations and victory animations will be added in
                      future updates!
                    </div>
                  </CardContent>
                </Card>
