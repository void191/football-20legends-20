...
export default function PlayerCard({
  ...
  return (
    ...
    >
      ...
      {/* Rarity Glow */}
      <div className={`absolute inset-0 bg-gradient-to-br ${rarityConfig[rarity].bg} opacity-50 blur-xl`}></div>
      ...
      <CardContent className="relative p-4">
        ...
        <div className="flex items-start justify-between mb-3">
          <div>
            ...
            <div className="flex items-center gap-2">
              <Badge className={`text-xs ${positionColors[position]} text-white`}>
          ...
          {/* Overall Rating */}
          <div className={`w-12 h-12 rounded-full ${getOverallColor(stats.overall)} flex items-center justify-center font-bold`}>
            {stats.overall}
          </div>
        </div>
        ...
        <div className="space-y-2 mb-3">
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className={`font-bold ${getStatColor(stats.speed)}`}>{stats.speed}</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`font-bold ${getStatColor(stats.shooting)}`}>{stats.shooting}</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`font-bold ${getStatColor(stats.passing)}`}>{stats.passing}</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`font-bold ${getStatColor(stats.defending)}`}>{stats.defending}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            <span className={`text-xs font-medium ${rarityConfig[rarity].text} capitalize`}>
              {rarity}
            </span>
          </div>
