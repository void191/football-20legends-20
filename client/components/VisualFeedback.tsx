...
interface FeedbackEvent {
  id: string;
  type: 'xp' | 'level_up' | 'trophy' | 'goal' | 'save' | 'skill' | 'achievement';
  value?: number;
  message?: string;
...
export default function VisualFeedback({
  ...
  const getFeedbackDuration = (type: string) => {
    switch (type) {
      case 'xp': return 2000;
      case 'level_up': return 4000;
      case 'trophy': return 3000;
      case 'goal': return 5000;
      case 'save': return 2500;
      case 'skill': return 3000;
      case 'achievement': return 4000;
      default: return 2000;
    }
  };
      ...
      {activeEvents.map(event => {
        ...
        return (
          <div key={event.id} className="absolute inset-0">
            ...
            {(event.type === 'level_up' || event.type === 'goal' || event.type === 'achievement') && (
              <div 
