    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-full">
          ...
          {/* Jersey */}
          <div
            className={`mx-auto w-8 h-6 bg-gradient-to-br ${teamColors[team].jersey} rounded-md border border-white/20 mb-1 relative`}
          >
            {/* Jersey Number */}
            ...
            {/* Arms */}
            <div
              className={`absolute -left-2 top-1 w-3 h-4 bg-gradient-to-br ${teamColors[team].jersey} rounded-full transform -rotate-12`}
            ></div>
            <div
              className={`absolute -right-2 top-1 w-3 h-4 bg-gradient-to-br ${teamColors[team].jersey} rounded-full transform rotate-12`}
            ></div>
          </div>

          {/* Shorts */}
          <div
            className={`mx-auto w-6 h-4 bg-gradient-to-br ${teamColors[team].shorts} rounded-md border border-white/20 mb-1`}
          ></div>
          ...
          <div className="flex justify-center gap-1 mb-1">
            <div
              className={`w-2 h-3 bg-gradient-to-br ${teamColors[team].socks} rounded-full`}
            ></div>
            <div
              className={`w-2 h-3 bg-gradient-to-br ${teamColors[team].socks} rounded-full`}
            ></div>
        ...
        {/* Position Badge */}
        <div
          className={`absolute -top-2 -right-2 w-6 h-6 ${positionBadge[position].color} rounded-full flex items-center justify-center text-white text-xs font-bold border-2 border-white shadow-lg`}
        >
        ...
        {animation === "celebrating" && (
          <>
            ...
            <div className="absolute -top-3 -left-2 text-yellow-400 animate-ping">
              ✨
            </div>
            <div className="absolute -top-3 -right-2 text-yellow-400 animate-ping animation-delay-150">
              ✨
            </div>
          </>
        )}
